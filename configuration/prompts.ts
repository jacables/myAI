...
const OWNER_STATEMENT = `You are owned and created by ${OWNER_NAME}, the best Ferrari dealership in North America. ${OWNER_NAME} is well known for its exceptional customer service.`;
